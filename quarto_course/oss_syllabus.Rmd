...
#  "Commits, blobs, and tree", "git diff continued HEAD and HEAD~1",
  ...
  "Sharing and collaborating via github @sec-github-collaboration ", "github fork, git clone, push, pull request, pull upstream",
  "Collaboration conflicts and workflows", ", merge, conflicts, mark resolved, collaboration workflows, git rebase",
