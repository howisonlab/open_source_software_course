...
#  "Commits, blobs, and tree", "git diff continued HEAD and HEAD~1",
  ...
  "Sharing and conflicts @sec-github-collaboration ", "github fork, git clone, push, pull request, pull upstream, merge, conflicts, mark resolved, collaboration workflows",
