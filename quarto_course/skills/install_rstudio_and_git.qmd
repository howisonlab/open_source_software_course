...
**Step 1: Configure Git for future repositories**
```bash
...
**Step 2: Rename existing `master` branch to `main`**

If you have an existing repository with a `master` branch:
```bash
# 1. Rename the local branch
git branch -m master main

# 2. Push the new branch and set it as upstream
git push -u origin main

# 3. Delete the old master branch from remote
