...
2. Where is it developed? Find the repository. How do you know this is the right one?
3. Trace its path to your computer by identifying each of the four packaging elements:
    1. **Encapsulation**: What does the package directory structure look like in the repo?
    2. **Metadata**: Find the metadata file. What dependencies does it declare?
    3. **Distribution server**: Where is it published? Find its PyPI page.
    4. **Install tool**: How did you install it, and how did `pip` know where to get it from?
4. How did the code get from the repository to PyPI? Can you find evidence of the release process (e.g., GitHub Actions, tagged releases)?
5. **(bonus)** Can you find the package code on your own computer? Python packages know where they are installed. Can you find, write, or generate code that tells you the location of your package on your disk?
