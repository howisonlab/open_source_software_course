...
```sh
$ git viz
* 5988585 (main) database 2
* 3eff4b3 database 1
| * b7e1b11 (HEAD -> pie_chart_branch) pie chart 3
| * 6beebfd pie chart 2
| * b458a22 pie chart 1
|/  
* 63e71c6 (origin/main, origin/HEAD) second commit
* f9981b3 first commit
* a3f0539 Initial commit
```
