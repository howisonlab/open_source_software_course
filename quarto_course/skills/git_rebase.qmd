...
Each line is a commit, the lines are instructions and are executed in order.
...
This is because the `origin/` branches are shwoing (and those are up on the GitHub server and not yet changed).
