...
#### UT Austin open source projects
...
Submit by making a PR to  https://github.com/howisonlab/oss_spring2023_assignments/projects/<yourname> Note that it should be a separate PR from other assignment submissions; this means you must use a different branch name for this work.
...
insight_topics <- tribble(
  ~insight_topic,
  #----------
  "What is open source? @sec-what-is-open-source Paper Planes and Innovation @sec-paper-planes-and-innovation",
...
no_meetings <- tribble(
  ...
  #--------------------
   "2024-01-15", "2024-01-15", "No meeting: MLK day",
   "2024-03-11", "2024-03-15", "No meeting: Spring Break",
   "2024-03-04", "2024-03-08", "No meeting: Project Time",
...
first_class_day = parse_datetime("2024-01-15")

last_class_day = parse_datetime("2024-04-29")

first_mon = parse_datetime("2024-01-15")

first_wed = parse_datetime("2024-01-17")
