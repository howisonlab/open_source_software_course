...
header <- tribble(
  ...
  "Office Hours Availability", "Thursdays and Fridays 9am-3pm by appointment",
  "Office Hours Link", "https://calendly.com/beason-utexas/30min",
  "Contact Email", "wab773@eid.utexas.edu"
)
library(knitr)
```
