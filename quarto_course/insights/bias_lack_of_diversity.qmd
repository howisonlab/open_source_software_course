...
- [Coraline Ada Ehmke’s Contributor’s Covenant](https://www.contributor-covenant.org/version/1/0/0/code-of-conduct/)
- [Linus Torvalds’ Code of Conflict](https://www.kernel.org/doc/html/v4.10/process/code-of-conflict.html) and [commentary](https://lwn.net/Articles/765108/).
...
- ["Nearly All of Wikipedia Is Written By Just 1 Percent of Its Editors"](https://web.archive.org/web/20180322105812/https://motherboard.vice.com/en_us/article/7x47bb/wikipedia-editors-elite-diversity-foundation)

- Examine these "developer surveys" to add data (agreeing or disagreeing) with the opening statement of this page:
  - <https://survey.stackoverflow.co/2022/>
  - <https://octoverse.github.com/>

## Additional readings (will be assigned to groups):
...
1. What types of diversity does the literature discuss?
How does open source compare to: a) the world, b) software industry as a whole.
...
4. What authority or legitimacy does work to improve diversity draw on?

5. What arguments support the idea that a lack of diversity means that open source is failing to live up to its own ideals?

6. What arguments are presented by those unconcerned about lack of diversity in open source? What values do they discuss?
